...
const WomenPage = () => {
    ...
    const womenWatches = [
        ...
        { id: 7, brand: 'KENNETH COLE', model: 'WOMEN', price: '4000', image: '/images/Item-card-image-8.png' },
    ...
    return (
        <div className="w-full font-lato">
            ...
            <CollectionHeader bgImage="/images/womens-collection.png" />
